    ...
    return (
        <div className="space-y-8 font-pixel pb-24">
            <div className="text-center mt-8">
                <h1 className="text-2xl text-yellow-400 mb-2">QUEST LOG</h1>
                <p className="text-xs text-gray-400">AVAILABLE MISSIONS</p>
            </div>
            ...
            {loading ? (
                ...
                <div className="text-center p-12 bg-slate-800 border-4 border-slate-600">
                    <p className="text-gray-500 text-xs">NO QUESTS AVAILABLE.</p>
                </div>
            ) : (
